...
class VoiceParserProvider {
   ...
   * @returns {Promise<{expenses: Array<{amount: number|null, currency: string, merchant: string|null, category: string|null, date: string|null, note: string|null, confidence: number|null}>, warnings: string[]}>}
