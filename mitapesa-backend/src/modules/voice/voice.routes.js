...
const { checkVoiceUsageAllowed, recordVoiceUsage } = require("../../lib/aiUsage");
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (!usageCheck.allowed) throw forbidden(usageCheck.reason);
    ...
    if (input.audioBase64) {
      ...
      if (!transcript) {
        ...
        await recordVoiceUsage(req.userId, totalCostUsd);
