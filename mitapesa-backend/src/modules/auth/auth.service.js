...
async function registerUser({ firstName, lastName, email, phone, password, phoneVerifyToken, emailVerifyToken, termsVersion, ip }) {
  ...
  const user = await prisma.$transaction(async (tx) => {
    const created = await tx.user.create({
      data: {
        ...
        // Server-generated timestamp, not client-supplied — this is what
        // makes it usable as real evidence rather than a claim the app
        // could have fabricated or the customer could dispute the timing of.
