import { LayoutDashboard, Users, MessageSquareWarning, Settings, ScrollText, LogOut, ShieldCheck, Megaphone, Landmark, Percent, Package, TrendingUp, UserCog, Scale, DollarSign, Sparkles } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { key: "aiUsage", label: "AI usage", icon: Sparkles, minRole: "admin_viewer" },
    ...
    <div className="flex h-screen bg-bgSoft">
      <aside className="w-64 shrink-0 bg-ink flex flex-col">
        <div className="px-6 py-6 flex items-center gap-2.5">
          ...
          <div>
            <p className="text-white font-display font-bold text-[15px] leading-tight">MitaPesa</p>
