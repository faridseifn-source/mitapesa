...
export const adminApi = {
  ...
  // This calendar month's actual voice-logging AI spend and usage,
  // against the configured ceiling — same backend endpoint the mobile
  // app's own Admin portal already reads.
  aiUsage: () => raw("/admin/ai-usage"),
  // A specific customer's full voice-credit picture — total purchased,
  // used, remaining, and every individual purchase.
  voiceCredits: (userId) => raw(`/admin/voice-credits/${userId}`),
  ...
  clearVoiceCredits: (userId) => raw(`/admin/voice-credits/${userId}/clear`, { method: "POST" }),
