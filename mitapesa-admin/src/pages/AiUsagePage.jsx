...
export default function AiUsagePage({ user }) {
  ...
  // same underlying OpenAI account — this page reports one at a time,
  // switched by this toggle, rather than a combined total that would
  // hide which feature is actually driving cost or revenue.
