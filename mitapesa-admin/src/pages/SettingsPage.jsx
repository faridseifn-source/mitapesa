...
const LABELS = {
  ...
  analytics_enabled: "AI analytics (\"Ask AI\") enabled",
  analytics_free_monthly_limit: "Free AI questions per customer/month",
  analytics_monthly_spend_ceiling_usd: "AI analytics monthly spend ceiling (USD)",
  analytics_promo_free_until: "AI analytics promo — free until (YYYY-MM-DD)",
  analytics_credit_pack_size: "AI analytics credit pack — questions per purchase",
  analytics_credit_pack_price_tzs: "AI analytics credit pack — price (TZS)",
  analytics_credit_purchase_simulated_failure_rate: "AI analytics purchase — simulated decline rate (%)",
};
const HELP = {
  ...
  analytics_enabled: "\"true\" or \"false\" — turns the \"Ask AI\" feature off for customers entirely.",
  analytics_free_monthly_limit: "How many AI analytics questions each customer gets free per calendar month. Independent of voice logging's own free limit — these are two separate budgets.",
  analytics_monthly_spend_ceiling_usd: "Once this month's total estimated AI-analytics cost (all customers combined) reaches this dollar amount, \"Ask AI\" automatically turns itself off for everyone until next month. This is a separate ceiling from voice logging's own — both share the same underlying OpenAI account, so your true maximum combined OpenAI spend is roughly this number plus voice's own ceiling, not either one alone.",
  analytics_promo_free_until: "Leave blank for no active promotion. Set a future date (YYYY-MM-DD) to make AI analytics free and unlimited for every customer until that date — the monthly spend ceiling above still applies even during a promotion.",
  analytics_credit_pack_size: "How many extra AI analytics questions one purchase unlocks. These never expire, unlike the free monthly allowance.",
  analytics_credit_pack_price_tzs: "Price of one AI analytics credit pack, in TZS.",
  analytics_credit_purchase_simulated_failure_rate: "0-100. Injects simulated card declines on the mock payment gateway, to test the failure-handling path before a real gateway is connected.",
};
