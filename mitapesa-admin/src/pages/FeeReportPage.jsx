    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-1.5">
          ...
          <p className="text-[11.5px] text-inkFaint mb-8">"AI features" is revenue from customers buying more voice-logging usage beyond their free monthly allowance — see the AI Usage page for spend, and per-customer purchase history.</p>
