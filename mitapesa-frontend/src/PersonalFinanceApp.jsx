  ...
  return (
    <div className="flex flex-col h-screen px-6 pt-6 pb-8">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2"><div className="w-8 h-8 rounded-[10px] flex items-center justify-center" style={{ background: t.accent }}><MitaPesaMark size={16} color="#fff" /></div><span className="text-[14px] font-bold" style={{ color: t.ink, fontFamily: "'Space Grotesk', sans-serif" }}>MitaPesa</span></div>
...
function Header({ t, dark, setDark, user, avatarUrl, notifications, language, setLanguage, tr, onAvatarClick, onOpenNotifications }) {
  ...
  return (
    <div className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] z-30 flex items-center justify-between px-4 py-2.5 backdrop-blur" style={{ background: `${t.bg}E6`, borderBottom: `1px solid ${t.border}`, paddingTop: "max(0.625rem, env(safe-area-inset-top))" }}>
      <div className="flex items-center gap-2">
        <div className="w-8 h-8 rounded-[10px] flex items-center justify-center shrink-0" style={{ background: t.accent }}><MitaPesaMark size={17} color="#fff" /></div>
