...
function App() {
  ...
  useEffect(() => {
    ...
    // Keep the native status bar's text/icon color legible against
    // whichever background is actually showing — dark background needs
    // light content, light background needs dark content. Safe to call
    // on web too; the native plugin no-ops outside a native platform.
    SystemBars.setStyle({ style: dark ? SystemBarsStyle.Light : SystemBarsStyle.Dark }).catch(() => {});
  }, [dark]);
